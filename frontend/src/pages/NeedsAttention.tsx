    ...
    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
      <div style={{ marginBottom: '1.5rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          <HiOutlineExclamationTriangle size={24} style={{ color: '#ffffff' }} />
      ...
      {pendingDecisions.length > 0 && (
        <div className="glass-card" style={{ marginBottom: '1.5rem', borderColor: 'rgba(255, 255, 255, 0.25)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
            <HiOutlineExclamationTriangle size={20} style={{ color: '#ffffff' }} />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            {pendingDecisions.map(d => (
              <div key={d.id} className="glass-card" style={{ padding: '1rem', background: 'rgba(255, 255, 255, 0.025)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.5rem' }}>
                  <div>
                    <div style={{ fontWeight: 700, fontSize: '1rem', color: '#ffffff' }}>{d.bill_name}</div>
                    <div style={{ fontSize: '0.75rem', color: '#94a3b8' }}>Action: {d.agent_action}</div>
                  </div>
                ...
                {d.draft_content && (
                  <pre style={{ background: 'rgba(0, 0, 0, 0.4)', color: '#ffffff', padding: '0.75rem', borderRadius: 8, fontSize: '0.75rem', whiteSpace: 'pre-wrap', border: '1px solid rgba(255,255,255,0.1)' }}>
                    {d.draft_content}
                  </pre>
                )}
      ...
      {insightsLoading ? (
        ...
        <div className="glass-card" style={{ textAlign: 'center', padding: '3rem', color: '#94a3b8' }}>
          <div style={{ fontWeight: 700, fontSize: '1.1rem', color: '#ffffff', marginBottom: '0.25rem' }}>No Action Items Required</div>
